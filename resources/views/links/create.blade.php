...
<div class=" pb-1">
    ...
    <h3 class="text-center mt-3">  Link belongs to {{$tilename}} </h3>
</div>
<form action="{{route('links.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form  border bg-blue-transparent p-3">
        <div class="row">
            <div class=" col-12">
                {{-- <div class="mb-3 ">
                    ...
                    <input type="text" name="name" class="form-control" id="name" value="No Name">
                </div> --}}
                <div class="mb-3">
                ...
                {{-- <div class="mb-3 ">
                    ...
                    <input type="url" name="link" class="form-control" id="link" value="www.com">
                </div> --}}
            ...
            <div class="col-lg-4 col-12">
                <div class="d-flex">
                    {{-- <div class="mb-3 d-sm-flex align-items-center" id="personal-info">
                        <div class="mb-0 me-5 d-flex flex-column gap-1">
                            ...
                            <span class="avatar avatar-xxl avatar-rounded ms-4">
                                <img id="profile-img" src="{{asset('assets/images/faces/15.jpg')}}" class="me-5" alt="">
                                <a href="javascript:void(0);"
                                    class="badge rounded-pill bg-primary avatar-badge me-3">
                    ...
                    {{-- <div class="mb-3 w-100">
                        ...
                        <input type="color" name="color" class="form-control mt-4" id="color" value="#456789">
                    </div> --}}
                </div>
                {{-- <div class="mb-3">
                    <label for="key" class="form-label fs-14 text-dark">Key</label>
                    <input type="text" class="form-control" id="key"
                        placeholder="key for increption and decreption">
                </div> --}}
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-secondary mb-2 text-center" type="submit">Add New Link <i class="ms-1 bi bi-check-square"></i>
            </button>
        </div>
    </div>
</form>
